...
class RestaurantServicesImpl (
    private val restaurantRepository: RestaurantRepository) : RestaurantServices {
    ...
    override fun save(restaurantDTO: RestaurantDTO): RestaurantDTO {
        restaurantRepository.findByCode(restaurantDTO.code)?.let {
            throw EntityAlreadyExists("Restaurant with code ${restaurantDTO.code} already exists")
        }
